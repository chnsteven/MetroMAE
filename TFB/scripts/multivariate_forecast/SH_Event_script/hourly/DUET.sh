...
COMMON_HP='{"seq_len": 576, "norm": true, "batch_size": 8, "d_ff": 512, "d_model": 512, "dropout": 0.5, "e_layers": 1, "factor": 3, "fc_dropout": 0.1, "k": 1, "loss": "MAE", "lr": 0.0005, "lradj": "type1", "n_heads": 1, "num_epochs": 100, "num_experts": 2, "patch_len": 48, "patience": 5, "CI": true}'
